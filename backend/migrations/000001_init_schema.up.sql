...
CREATE INDEX idx_cve_findings_scan_date ON cve_findings(scan_date);
CREATE INDEX idx_cve_findings_cve_id ON cve_findings(cve_id);
...
CREATE INDEX idx_deployment_reports_received_at ON deployment_reports(received_at);
